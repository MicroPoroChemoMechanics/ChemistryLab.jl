...
# Ferrihydrite's weak sites at Dzombak and Morel's own site density, which the
# fixture records with the amount and the area it comes from. That density is
# not a detail: a surface a thousand times more dilute carries a thousandth of the
...
#
# The fixture carries its own provenance: generator, versions, the md5 of
# phreeqc.dat, the site amount, the area and the constants.
